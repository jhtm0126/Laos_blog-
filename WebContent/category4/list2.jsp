  ...
  $.ajax({
    ...
    success: function(rdata) {
      ...
      for (var i = 0 ; i < rdata.list.length;  i++) { // 0 ~
        ...
        str += "   <TD class='td_basic'>" + rdata.list[i].cnt + "</TD>";
        str += "   <TD class='td_basic'>";
        str +="    <A href=../category4/decreaseSeqno.jsp?categoryno="+rdata.list[i].categoryno+"><IMG src='./images/up.jpg' style='width: 16px;' title='우선순위 높임'></A>  ";
        str +="    <A href=../category4/increaseSeqno.jsp?categoryno="+rdata.list[i].categoryno+"><IMG src='./images/down.jpg' style='width: 16px;' title='우선순위 낮춤'></A>";
        str += "   <A href='javascript: update_form(" + rdata.list[i].categoryno + ");'><IMG src='./images/update.png' style='width: 16px;'></A>";
        str += "   <A href='javascript: delete_form(" + rdata.list[i].categoryno + ");'><IMG src='./images/delete.png' style='width: 16px;'></A>";
        str +="</TD>"; 
        str += "</TR>";
...
<DIV class='content'>
  ...
  <DIV id='panel' class='popup1' style='display: none;  height: 250px;'>
    ...
    <DIV id='panel_close' style='margin: 0px auto; text-align: center; height:50px;'>
