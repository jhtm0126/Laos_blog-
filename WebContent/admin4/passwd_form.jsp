...
<FORM name='frm' method='POST' action='./passwd_proc.jsp'
  ...
  <fieldset class='fieldset_no_line'>
    <ul>
      <li class='li_none'>
        <label for='passwd'  class='label_basic' style='width: 200px;'>기존 패스워드</label>
        <input type='password' name='passwd' id='passwd' required="required">
      </li>
      <li class='li_none'>
        <label for='new_passwd'  class='label_basic' style='width: 200px;'>새로운 패스워드</label>
        <input type='password' name='new_passwd' id='new_passwd' required="required">
      </li>
      <li class='li_none'>
        <label for='new_passwd2'  class='label_basic' style='width: 200px;'>새로운 패스워드 확인</label>
