...
<DIV class='aside_menu'>
  <ASIDE style='float: left; font-weight: bold; font-size:35px; '>회원가입</ASIDE> 
  ...
  <fieldset class='fieldset_no_line' style='width: 90%; margin: 0px auto;'>
    <ul>
      ...
      <li class='li_left'>
        ...
        <input type='email' name='email' id='email' required="required" value='testcell2010@gmail.com' style='width: 35%;'>
      ...
      <li class='li_left'>
        ...
        <input type='text' name='tel' id='tel' value='000-1111-1111' >*
      </li>
            
      <li class='li_left'>
        <label for='zipcode' class='label_basic'>우편번호</label>
        <input type='text' name='zipcode' id='zipcode' value='' style='width: 10%;'>
      ...
      <li class='li_none' style='padding-left: 150px;'>
