...
<FORM name='frm' method='POST' action='./.jsp'>
  <fieldset class='fieldset_no_line'>
    <ul>
      ...
      int count = adminProc.create(admin4VO);
      if (count == 1){
      %>
        등록에 성공 했습니다.<br>
        회원 가입시 입력한 이메일 주소로 가입 확인 링크를 전송했습니다.<br>
...
content += "http://172.16.12.11:9090/laos_v3jq/admin4/confirm.jsp?email=" + admin4VO.getEmail() + "&auth=" + auth;
