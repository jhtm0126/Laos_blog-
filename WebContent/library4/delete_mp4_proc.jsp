...
if (libraryProc.passwordCheck(libraryno, pw) == 1) { // 패스워드 일치
  ...
  Tool1.deleteFile(upDir, libraryVO.getVideo());       // 기존 파일 삭제
 
  count = libraryProc.delete_video(libraryno); 
...
%>
  ...
  <DIV class='bottom_menu'>
    ...
    %>
      <button type='button' onclick="location.href='./read.jsp?categoryno=<%=categoryno %>&librarno=<%=libraryno %>'">확인</button>
