...
<DIV class='content'>
  ...
  <DIV class='aside_menu'>
    <ASIDE style='float: left;'><A href='../category4/list.jsp'>게시판</A>＞<A href='./list.jsp?categoryno=<%=categoryno %>'><%=category_title %></A> > 수정 > Youtube 등록</ASIDE> 
  ...
  <DIV class='message'>
    ...
    if (libraryProc.passwordCheck(libraryno, pw) == 1) { // 패스워드 일치
      ...
      count = libraryProc.new_create_youtube(libraryVO);
      if (count == 1) {
      %>
